...
public class GetEdgesScenarioProvider implements ApiScenarioProvider {
    ...
    public ApiScenarioDefinition getDefinition() {
        List<ApiTestScenario> scenarios = List.of(
                ApiTestScenario.builder()
                        .scenario("Scenario 1")
                        .description("Lấy danh sách edges thành công với floor_id hợp lệ")
        ...
        return ApiScenarioDefinition.builder()
                ...
                .apiLabel("GET /api/v1/map/edges")
                .endpoint("/api/v1/map/edges")
